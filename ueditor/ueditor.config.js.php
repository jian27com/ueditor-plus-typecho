<?php
defined('__TYPECHO_ROOT_DIR__') or exit;
...
(function () {
    ...
    var URL = '<?php echo Typecho_Common::url(__TYPECHO_PLUGIN_DIR__. '/UEditor/ueditor/', $options->siteUrl);?>';
    window.UEDITOR_HOME_URL = '<?php echo Typecho_Common::url(__TYPECHO_PLUGIN_DIR__. '/UEditor/ueditor/', $options->siteUrl);?>';
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,charset:"utf-8"editor!'    //初始化编辑器的内容,也可以通过textarea/script给
